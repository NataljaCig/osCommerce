...
if (isset($HTTP_GET_VARS['action']) && ($HTTP_GET_VARS['action'] == 'update')) {
    ...
    if (isset($HTTP_GET_VARS['notify']) && !empty($HTTP_GET_VARS['notify'])) {
...
<div class="contentContainer">
    <div class="contentText">
        <?php echo EMAIL_TEXT_SUBJECT_OPEN_INFO; ?>
    </div>
    ...
    <div class="buttonSet">
        <span
            class="buttonAction"><?php echo tep_draw_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', null, 'primary'); ?></span>
    </div>
</div>
