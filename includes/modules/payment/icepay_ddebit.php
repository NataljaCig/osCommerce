...
class icepay_ddebit extends icepay
{
    ...
    function icepay_ddebit()
    {
        ...
        $this->enabled = ($this->doAllowedCurrencyCheck('EUR') && (MODULE_PAYMENT_ICEPAY_DDEBIT_STATUS == 'True') ? true : false);
        ...
        $this->redirect_url = $this->base_url . '?type=ddebit';
    }
    ...
    function getLangStr($str)
    {
        switch ($str) {
            case "title":
                return MODULE_PAYMENT_ICEPAY_DDEBIT_TEXT_TITLE;
                break;
        }
    }
    ...
    function process_button()
    {
        ...
        tep_draw_hidden_field('ic_country', $this->getUserCountry(MODULE_PAYMENT_ICEPAY_DDEBIT_COUNTRY)) .
        tep_draw_hidden_field('ic_currency', $this->getUserCurrency(MODULE_PAYMENT_ICEPAY_DDEBIT_CURRENCY)) .
        tep_draw_hidden_field('ic_language', $this->getUserLanguage(MODULE_PAYMENT_ICEPAY_DDEBIT_LANGUAGE)) .
        tep_draw_hidden_field('ic_amount', $this->getOrderAmount(MODULE_PAYMENT_ICEPAY_DDEBIT_CURRENCY)) .
